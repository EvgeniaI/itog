package com.example.attestation.models;
...
public class Product {
    ...
    @Min(value = 1, message = "Стоимость товара не может быть пустой или отрицательной")
    private float price;
    ...
    //метод позволяет добавить фото в лист текущего продукта
    public void addImageToProduct(Image image){
        image.setProduct(this);
        imageList.add(image);
    }

    //метод будет заполнять дату и время при создании объекта класса
    @PrePersist
    private void init(){
